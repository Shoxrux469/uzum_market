...
//   <svg class="logo hidden cursor-pointer w-2/12 lg:block" data-v-aa1700bc="" viewBox="0 0 215 32" fill="none"
...
//           fill="#7000FF"></path>
//   </svg>
//   <div class="header_btns w-full lg:w-auto flex items-center gap-2">
//       <button
...
//       </button>
//       <div
//           class="searcher_div flex justify-between bg-[#edeff2] pl-1 items-center rounded-lg w-fit lg:border lg:border-gray-300 w-full lg:rounded-md">
//           <input class="w-full lg:w-96 rounded-lg bg-[#edeff2] border-none h-8 text-gray-500" type="text"
//               placeholder="Искать товары и категории">
//           <img class="hidden lg:block bg-gray-100 px-6 py-2 rounded-r" src="/public/searcher_icon.svg" alt="">
//       </div>
//   </div>
...
//           <li class="text-[#595b66] h-[28px] cursor-pointer border-black">Автотовары</li>
//           <li class="text-[#595b66] h-[28px] cursor-pointer border-black">Детские товары</li>
//           <li class="text-[#595b66] h-[28px] cursor-pointer border-black flex items-center gap-1">Еще <img src="/public/arrow_bottom.svg" alt=""></li>
//            `;
// }
...
export function reload_products(arr, place) {
  ...
  for (let item of arr) {
    ...
    product_card.classList.add("w-[230px]");
